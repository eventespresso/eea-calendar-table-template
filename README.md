EE4 Calendar Table Template
=========

[![Latest Release](https://img.shields.io/github/tag/eventespresso/eea-calendar-table-template.svg?style=flat&label=Latest%20Release)](https://github.com/eventespresso/eea-calendar-table-template/releases)
...
This is a calendar table template for Event Espresso 4 Core
...
> Note, this add-on has not been released yet.  Use at your own risk.

| **Some Links**|     |
|---- | --- |
**Support License** | Support for this add-on is not provided through this repository.  For support you can purchase a [Premium Support License](https://eventespresso.com/pricing?utm_source=github&utm_medium=link&utm_campaign=ee_addon_description_readme&utm_content=premium+support+license).
